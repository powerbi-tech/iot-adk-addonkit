...
These tools are part of the [Windows 10 IoT Core (IoT Core) ADK Add-Ons](../ReadMe.md), in the \\Tools folder. To learn more about these tools, see [What's in the Windows ADK IoT Core Add-ons](iot-core-adk-addons.md).

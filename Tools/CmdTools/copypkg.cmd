...
:Usage
echo Usage: copypkg [-Source] [-Destination] [-PkgName] 
echo    Imports pkg into the current workspace
echo    Source ........... Source workspace dir to copy from.
echo    Destination ...... Desitnation workspace dir to copy to.
echo    PkgName .......... pkg to copy
...
call RunPSCommand.cmd "Copy-IoTOEMPackage" %*
